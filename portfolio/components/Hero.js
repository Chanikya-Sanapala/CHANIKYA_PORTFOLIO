  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto space-y-8">
        ...
        <p className="text-xl md:text-2xl text-gray-300 font-normal max-w-2xl mx-auto leading-relaxed md:animate-fade-in-up md:[animation-delay:200ms]">
          Building scalable, user-friendly web applications with precision and passion.
        </p>

        <div className="pt-8 flex flex-col md:flex-row items-center justify-center gap-4 md:animate-fade-in-up md:[animation-delay:400ms]">
